...
export function EditPersonalityClient({ personality }: { personality: Personality }) {
  ...
  const [imageUrl, setImageUrl] = useState(personality.image_url || '');
  const [preview, setPreview] = useState<string | null>(personality.image_url || null);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    router.push(`/personalities/${personality.id}`);
  }
